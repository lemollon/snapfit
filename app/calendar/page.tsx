                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 p-6">
                  ...
                  {selectedDayData.photos.length > 0 ? (
                    ...
                    <div className="text-center py-8">
                      ...
                      <button className="mt-4 px-6 py-2.5 bg-gradient-to-r from-purple-500 to-pink-500 hover:shadow-lg hover:shadow-purple-500/25 text-white rounded-xl transition-all font-medium">
                        Upload Photo
                      </button>
                    </div>
                  )}
